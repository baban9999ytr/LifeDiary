...
public class DiaryEntry implements Serializable {
    ...
    @ColumnInfo(name = "socialMentions")
    String socialMentions;

    @ColumnInfo(name = "moodTheme")
    String moodTheme;
    ...
    public String getCoverPhotoUri() { return coverPhotoUri != null ? coverPhotoUri : ""; }
    public void setCoverPhotoUri(String coverPhotoUri) { this.coverPhotoUri = coverPhotoUri; }

    public String getAudioPath() { return audioPath != null ? audioPath : ""; }
    ...
    public String getEntryPasswordHash() { return entryPasswordHash != null ? entryPasswordHash : ""; }
    ...
    public String getHandwritingImagePath() { return handwritingImagePath != null ? handwritingImagePath : ""; }
    ...
    public String getSocialMentions() { return socialMentions != null ? socialMentions : ""; }
    public void setSocialMentions(String socialMentions) { this.socialMentions = socialMentions; }

    public String getMoodTheme() { return moodTheme != null ? moodTheme : ""; }
    public void setMoodTheme(String moodTheme) { this.moodTheme = moodTheme; }

    public String getWeather() { return weather != null ? weather : ""; }
    public void setWeather(String weather) { this.weather = weather; }

    public String getLocationInfo() { return locationInfo != null ? locationInfo : ""; }
