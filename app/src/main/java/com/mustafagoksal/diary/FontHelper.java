    ...
    public static void applyFont(Context ctx, TextView tv, String fontKey) {
        switch (EntryFont.fromKey(fontKey)) {
            ...
            case DANCING:
                ...
                tv.setTypeface(ResourcesCompat.getFont(ctx, com.mustafagoksal.diary.R.font.dancing_script));
                break;
            case PLAYFAIR:
                tv.setTypeface(ResourcesCompat.getFont(ctx, com.mustafagoksal.diary.R.font.playfair_display));
                break;
            default:
